namespace _11.ArrayManipulator
{
    internal class Program
    {
        ...
        static int[] Exchange(int[] numbers, int index)
        {
            ...
            int changedArreyIndex = 0;

            for (int i = index + 1; i < numbers.Length; i++)
            {
                changedArray[changedArreyIndex] = numbers[i];
                changedArreyIndex++;
            }
        ...
        static void PrintMaxNumber(int[] numbers, string type) // even OR odd
        {
            int maxIndex = -1;
            int maxNumber = 0;
        ...
        static void PrintMinNumber(int[] numbers, string type) // even OR odd
        {
            int minIndex = -1;
